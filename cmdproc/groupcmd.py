...
毛票教友汇频道
https://t.me/+r8M60eytJVY1MjZl

夕阳红频道
https://t.me/+XBRB50LT75swMWJl

毛毛投频道
https://t.me/+8x3bZvMMVmliNmY1

旅行团友群：
https://t.me/joinchat/H7BPD0eLWqvSTPKB

音乐点播台
https://t.me/+JCr68ebTaDIwMzE1
...
https://t.me/c/1307935093/367
       """, disable_web_page_preview=True)
        context.job_queue.run_once(delete_reply_msg, delete_time, context=[
                                   msg, update.effective_message], name=f"delete_msg_{msg.message_id}")
    elif update.effective_chat.id == -1001500617553:
        msg = update.message.reply_text(
            """/y 音乐名称或是youtube链接 点播并下载音乐""", disable_web_page_preview=True)
        context.job_queue.run_once(delete_reply_msg, delete_time, context=[
                                   msg, update.effective_message], name=f"delete_msg_{msg.message_id}")
    else:  # 私聊时发送标准的内容回去
        msg = update.message.reply_text(
